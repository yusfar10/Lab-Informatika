...
/* --- Gaya untuk Kontainer Tabel --- */
        .table-container {
            padding: 20px;
            background-color: #ffffff; /* Latar belakang area di sekitar tabel */
            border-radius: 10px;
...
/* --- Gaya Hover Baris (Opsional) --- */
        .custom-table tbody tr:hover {
            background-color: #f0f7ff; /* Efek hover ringan */
        }
...
<div class="container mt-4" id="main-wrapper">
    ...
    <!-- FILTER -->
    <div class="d-flex gap-3 mb-4 table-container">
        ...
        <button class="btn btn-export-csv">Export CSV</button>
        <button class="btn btn-export-pdf">Export PDF</button>
    </div>
