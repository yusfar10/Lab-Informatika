...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        $users = [
            ...
            [
                'name' => 'Kosma Informatika 3A',
                'username' => 'Kosma_it3A',
                'email' => 'Kosma_it3A@gmail.com',
            ...
            [
                'name' => 'Kosma Informatika 3B',
                'username' => 'Kosma_it3B',
                'email' => 'Kosma_it3B@gmail.com',
            ...
            [
                'name' => 'Kosma Informatika 3C',
                'username' => 'Kosma_it3C',
                'email' => 'Kosma_it3C@gmail.com',
